...
-- PUBLICATIONS --
insert into publication(id, bookshelf_id, name, type)
values (1, 1, 'Сборник произведений Оскара Уайльда', 'сборник'),
       (2, 2, 'Идиот -- Федор Достоевский', 'книга'),
       (3, 3, 'Введение в операционные системы', 'книга'),
       (4, 4, 'Собрание стихов Даниила Хармса', 'сборник'),
       (5, 5, 'Введение в системы баз данных', 'книга'),
       (6, 3, 'Идиот -- Федор Достоевский', 'книга');
